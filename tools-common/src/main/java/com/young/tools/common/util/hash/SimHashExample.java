...
public class SimHashExample {
    ...
    public SimHashExample(String tokens) {
        this.tokens = tokens;
        this.strSimHash = this.simHash();
    }

    public SimHashExample(String tokens, int hashbits) {
        this.tokens = tokens;
    ...
    public int hammingDistance(SimHashExample other) {
